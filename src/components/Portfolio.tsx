...
const Portfolio = () => {
  ...
  const cases = [
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1596462502278-27bfdc403348?w=800&h=600&fit=crop', // Placeholder beauty image
      logo: 'https://via.placeholder.com/64x64/ffffff/ff69b4?text=4F', // Placeholder logo
      link: '/case/4face',
