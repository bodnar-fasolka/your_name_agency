...
const TikTok = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto max-w-4xl text-center">
          <div className="fade-in">
            ...
            <p className="text-lg md:text-xl text-gray-600 mb-6 md:mb-8 max-w-2xl mx-auto font-light text-center">
              Вірусний контент для залучення нових клієнтів
            </p>
            ...
            <div className="w-full max-w-2xl mx-auto mb-6 md:mb-10">
              ...
              <p className="text-center text-lg text-gray-700 mt-4 md:mt-6 max-w-xs md:max-w-xl mx-auto">
                Розвивайте свій бізнес в TikTok
              </p>
            </div>
          </div>
        </div>
      ...
      {/* Section 2 - TikTok (title and text) */}
      <section className="py-16 px-4 bg-gray-50">
        <div className="container mx-auto max-w-4xl">
          ...
          <p className="text-lg md:text-xl text-gray-700 leading-relaxed text-center max-w-3xl mx-auto">
            TikTok — це не просто розваги, а одна з найпотужніших платформ для залучення нових клієнтів. Ми допомагаємо створювати відео, які працюють на ваш бренд, формують довіру та стимулюють продажі.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="space-y-6 text-lg text-gray-700 max-w-3xl mx-auto">
            <p>
              <strong className="text-black">Створення контент-стратегії для TikTok</strong> з урахуванням трендів
            </p>
            <p>
              <strong className="text-black">Виробництво відео:</strong> сценарії, зйомка, монтаж, адаптація під алгоритми
            </p>
            <p>
              <strong className="text-black">Запуск і оптимізація рекламних кампаній</strong> у TikTok Ads
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="space-y-6 text-lg text-gray-700 max-w-3xl mx-auto">
            <p>
              <strong className="text-black">1. Аналіз ринку та конкурентів</strong> – розуміємо, які формати та тренди працюють для вашої ніші.
            </p>
            <p>
              <strong className="text-black">2. Розробка контент-плану</strong> – створюємо ідеї для відео та плануємо регулярність виходу.
            </p>
            <p>
              <strong className="text-black">3. Виробництво відео</strong> – сценарії, зйомка, монтаж, оптимізація під алгоритми TikTok.
            </p>
            <p>
              <strong className="text-black">4. Реклама та просування</strong> – запускаємо TikTok Ads для збільшення охоплення й продажів.
            </p>
            <p>
              <strong className="text-black">5. Аналітика та оптимізація</strong> – постійно відстежуємо результати та вдосконалюємо контент і рекламу.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-lg text-gray-700 mb-8">
            Готові створювати вірусний контент в TikTok? Зв'яжіться з нами для детальної консультації.
          </p>
