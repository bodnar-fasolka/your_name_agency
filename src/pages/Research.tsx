...
// Lazy load Contact and Footer components
...
const Research = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Section 2 - Дослідження Description */}
      ...
      <section className="py-16 px-4 bg-white">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="space-y-6 text-lg text-gray-700 max-w-3xl mx-auto">
            <p><strong className="text-black">Портрет цільової аудиторії</strong> – хто ваш клієнт, його потреби, болі та мотиви.</p>
            <p><strong className="text-black">Мапа клієнтського шляху</strong> – як людина рухається від знайомства з брендом до покупки.</p>
            <p><strong className="text-black">Аналіз конкурентів і ринку</strong> – чим відрізняється ваш продукт і де є можливості для росту.</p>
            <p><strong className="text-black">Інсайти та перевірені гіпотези</strong> – що насправді працює, а що ні.</p>
            <p><strong className="text-black">Рекомендації для стратегії</strong> – які канали, меседжі та інструменти варто використовувати.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="space-y-6 text-lg text-gray-700 max-w-3xl mx-auto">
            <p><strong className="text-black">Спостереження</strong></p>
            <p><strong className="text-black">12 глибинних інтервю</strong> із кожною цільовою аудиторією</p>
            <p><strong className="text-black">Кількісне опитування</strong> для підтвердження гіпотез</p>
            <p><strong className="text-black">Бенчмаркінг</strong></p>
            <p><strong className="text-black">Інсайти</strong></p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="space-y-6 text-lg text-gray-700 max-w-3xl mx-auto">
            <p>Як нам залучити нових клієнтів котрі будуть купувати наш продукт</p>
            <p>Які ми можемо створити додаткові продукти і послуги, які будуть купувати наші наявні клієнти?</p>
            <p>Які продукти і послуги можна створити, щоб залучити нових клієнтів?</p>
          </div>
        </div>
      </section>
