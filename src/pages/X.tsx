    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto max-w-4xl text-center">
          <div className="fade-in">
            ...
            <p className="text-lg md:text-xl text-gray-600 mb-6 md:mb-8 max-w-2xl mx-auto font-light text-center">
              Швидка комунікація та експертний імідж
            </p>
            ...
            <div className="w-full max-w-2xl mx-auto mb-6 md:mb-10">
              ...
              <p className="text-center text-lg text-gray-700 mt-4 md:mt-6 max-w-xs md:max-w-xl mx-auto">
                Будуйте ваш експертний імідж в X
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="container mx-auto max-w-4xl">
          ...
          <p className="text-lg md:text-xl text-gray-700 leading-relaxed text-center max-w-3xl mx-auto">
            X — це платформа для швидкої комунікації та створення експертного іміджу. Ми допомагаємо бізнесам будувати діалог з аудиторією, ділитися експертністю та отримувати увагу через актуальні треди, пости та рекламу.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="space-y-6 text-lg text-gray-700 max-w-3xl mx-auto">
            <p>
              <strong className="text-black">Розробку tone of voice та контент-стратегії</strong> для X
            </p>
            <p>
              <strong className="text-black">Створення та публікацію постів і тредів,</strong> які залучають увагу
            </p>
            <p>
              <strong className="text-black">Запуск та оптимізацію рекламних кампаній</strong> у X Ads
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="space-y-6 text-lg text-gray-700 max-w-3xl mx-auto">
            <p>
              <strong className="text-black">1. Аналіз ніші та конкурентів</strong> – вивчаємо, які теми та формати працюють у вашій галузі.
            </p>
            <p>
              <strong className="text-black">2. Розробка tone of voice</strong> – формуємо стиль комунікації, щоб виділити ваш бренд серед інших.
            </p>
            <p>
              <strong className="text-black">3. Контент та пости</strong> – створюємо публікації, треди, меми й актуальні повідомлення.
            </p>
            <p>
              <strong className="text-black">4. Реклама в X Ads</strong> – налаштовуємо кампанії для залучення підписників і клієнтів.
            </p>
            <p>
              <strong className="text-black">5. Моніторинг та аналітика</strong> – аналізуємо ефективність, оптимізуємо контент і рекламу.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-lg text-gray-700 mb-8">
            Готові будувати експертний імідж в X? Зв'яжіться з нами для детальної консультації.
          </p>
