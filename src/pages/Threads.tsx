...
const Threads = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto max-w-4xl text-center">
          <div className="fade-in">
            ...
            <p className="text-lg md:text-xl text-gray-600 mb-6 md:mb-8 max-w-2xl mx-auto font-light text-center">
              Швидкі розмови та побудова спільноти
            </p>
      ...
      {/* Section 2 - Threads (title and text) */}
      <section className="py-16 px-4 bg-gray-50">
        <div className="container mx-auto max-w-4xl">
          ...
          <p className="text-lg md:text-xl text-gray-700 leading-relaxed text-center max-w-3xl mx-auto">
            Threads — це простір для швидких розмов і побудови спільноти. Ми допомагаємо бренду говорити з аудиторією просто і регулярно: короткі пости, живі обговорення, актуальні теми — усе, щоб вас бачили і чули.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="space-y-6 text-lg text-gray-700 max-w-3xl mx-auto">
            <p>
              <strong className="text-black">Контент-стратегію для Threads</strong> і календар постів
            </p>
            <p>
              <strong className="text-black">Створення й публікацію коротких повідомлень,</strong> запуск дискусій
            </p>
            <p>
              <strong className="text-black">Аналітику взаємодії</strong> та оптимізацію тем/форматів
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 bg-gray-100">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="space-y-6 text-lg text-gray-700 max-w-3xl mx-auto">
            <p>
              <strong className="text-black">1. Аналіз аудиторії та тем</strong> — визначаємо, про що варто говорити, щоб залучати саме ваших клієнтів.
            </p>
            <p>
              <strong className="text-black">2. Контент-рамка та tone of voice</strong> — формуємо стиль і формат постів, які впізнаватимуть.
            </p>
            <p>
              <strong className="text-black">3. Публікації та модерація</strong> — регулярно постимо, відповідаємо на коментарі, запускаємо обговорення.
            </p>
            <p>
              <strong className="text-black">4. Крос-промо</strong> — інтегруємо Threads з Instagram і іншими каналами для зростання охоплення.
            </p>
            <p>
              <strong className="text-black">5. Аналітика</strong> — відстежуємо залучення, теми, що «зайшли», оптимізуємо частоту та формат.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-lg text-gray-700 mb-8">
            Готові будувати спільноту в Threads? Зв'яжіться з нами для детальної консультації.
          </p>
