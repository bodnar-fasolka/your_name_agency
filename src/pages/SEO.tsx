    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto max-w-4xl text-center">
          <div className="fade-in">
            ...
            <p className="text-lg md:text-xl text-gray-600 mb-6 md:mb-8 max-w-2xl mx-auto font-light text-center">
              Фундамент видимості в пошукових системах
            </p>
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="container mx-auto max-w-4xl">
          ...
          <p className="text-lg md:text-xl text-gray-700 leading-relaxed text-center max-w-3xl mx-auto">
            SEO — це фундамент видимості бізнесу в пошукових системах. Ми допомагаємо вашому сайту з'являтися вище у Google, щоб клієнти знаходили вас швидше за конкурентів. Оптимізуємо структуру, контент і технічні параметри, щоб забезпечити стабільний потік органічного трафіку.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="space-y-6 text-lg text-gray-700 max-w-3xl mx-auto">
            <p>
              <strong className="text-black">Аудит сайту та конкурентів</strong>
            </p>
            <p>
              <strong className="text-black">Оптимізацію структури, контенту</strong> й швидкості завантаження
            </p>
            <p>
              <strong className="text-black">План і реалізацію довгострокового SEO-просування</strong>
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 bg-gray-100">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="space-y-6 text-lg text-gray-700 max-w-3xl mx-auto">
            <p>
              <strong className="text-black">1. SEO-аудит</strong> — перевіряємо сайт, аналізуємо конкурентів, формуємо список проблем і можливостей.
            </p>
            <p>
              <strong className="text-black">2. Ключові слова та стратегія</strong> — досліджуємо запити аудиторії та складаємо план просування.
            </p>
            <p>
              <strong className="text-black">3. On-page оптимізація</strong> — налаштовуємо структуру сайту, мета-теги, швидкість завантаження та контент.
            </p>
            <p>
              <strong className="text-black">4. Off-page оптимізація</strong> — формуємо посилальний профіль, працюємо з репутацією та зовнішніми згадками.
            </p>
            <p>
              <strong className="text-black">5. Моніторинг і звітність</strong> — відстежуємо позиції, трафік і конверсії, оптимізуємо стратегію щомісяця.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-lg text-gray-700 mb-8">
            Готові підняти свій сайт у Google? Зв'яжіться з нами для детальної консультації.
          </p>
