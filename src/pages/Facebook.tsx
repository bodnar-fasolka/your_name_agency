...
const Facebook = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto max-w-4xl text-center">
          <div className="fade-in">
            ...
            <p className="text-lg md:text-xl text-gray-600 mb-6 md:mb-8 max-w-2xl mx-auto font-light text-center">
              Ефективна реклама та управління контентом
            </p>
            ...
            <div className="w-full max-w-2xl mx-auto mb-6 md:mb-10">
              ...
              <p className="text-center text-lg text-gray-700 mt-4 md:mt-6 max-w-xs md:max-w-xl mx-auto">
                Довірте нам ваш Facebook маркетинг
              </p>
            </div>
          </div>
        </div>
      ...
      {/* Section 2 - Facebook (title and text) */}
      <section className="py-16 px-4 bg-gray-50">
        <div className="container mx-auto max-w-4xl">
          ...
          <p className="text-lg md:text-xl text-gray-700 leading-relaxed text-center max-w-3xl mx-auto">
            Ми знаємо, як налаштовувати рекламу, тестувати кампанії та створювати цікавий контент, який досягає вашої аудиторії та приносить результати.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="space-y-6 text-lg text-gray-700 max-w-3xl mx-auto">
            <p>
              <strong className="text-black">Повне налаштування рекламної кампанії</strong> на Facebook та Instagram (Meta Ads)
            </p>
            <p>
              <strong className="text-black">Постійне тестування та оптимізація</strong> кампанії
            </p>
            <p>
              <strong className="text-black">Професійне управління сторінкою</strong> та підтримка контенту
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="space-y-6 text-lg text-gray-700 max-w-3xl mx-auto">
            <p>
              <strong className="text-black">Аудит та визначення цілей</strong> – Ми починаємо з розуміння ваших бізнес-цілей та цільової аудиторії.
            </p>
            <p>
              <strong className="text-black">Налаштування реклами та план контенту</strong> – Створюємо рекламні кампанії, визначаємо формати та готуємо цікавий контент.
            </p>
            <p>
              <strong className="text-black">Тестування та оптимізація</strong> – Проводимо A/B-тестування, аналізуємо ефективність та оптимізуємо рекламу для досягнення кращих результатів.
            </p>
            <p>
              <strong className="text-black">Постійне управління</strong> – Управління вашою сторінкою, публікація контенту та щоденний моніторинг кампаній.
            </p>
            <p>
              <strong className="text-black">Звітність</strong> – Надання регулярних звітів з ключовими висновками та можливостями для зростання.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-lg text-gray-700 mb-8">
            Готові запустити ефективну рекламу на Facebook? Зв'яжіться з нами для детальної консультації.
          </p>
